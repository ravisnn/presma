        ...
        <div class="bg-white p-8 rounded shadow-md w-full">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="bg-blue-100 p-6 rounded-lg shadow-md">
                        <h5 class="text-xl font-semibold text-gray-800">Jumlah Pengguna</h5>
                        <p class="text-lg text-gray-600 mt-2"><?= esc($userCount); ?> Pengguna terdaftar di sistem.</p>
                    </div>

                    <!-- Card for Sertifikat Count -->
                    <div class="bg-green-100 p-6 rounded-lg shadow-md">
                        <h5 class="text-xl font-semibold text-gray-800">Jumlah Prestasi</h5>
                        <p class="text-lg text-gray-600 mt-2"><?= esc($prestasiCount); ?> Prestasi yang dikelola oleh admin.</p>
                    </div>
                </div>
        </div>
