        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <button type="button"
                    ...
                    <i
                        class="fas fa-chart-bar w-5 h-5 text-white transition duration-75 group-hover:text-white dark:text-gray-400 dark:group-hover:text-white"></i>
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Data Prestasi</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="<?php echo site_url('form_admin') ?>"
                            ...
                            <i class="fas fa-file-alt w-5 h-5 me-2"></i>Form Admin
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('form') ?>"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
                            <i class="fas fa-file-alt w-5 h-5 me-2"></i>Form Prestasi
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('table_admin') ?>"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
                            <i class="fas fa-table w-5 h-5 me-2"></i>Tabel Admin
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('table') ?>"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-800 dark:text-white dark:hover:bg-gray-700">
                            <i class="fas fa-table w-5 h-5 me-2"></i>Tabel Prestasi
                        </a>
                    </li>
                </ul>
            </li>
