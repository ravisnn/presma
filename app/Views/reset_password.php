    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-4xl text-center font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">Reset Your Password</h1>

                <!-- Reset Password Form -->
                <form action="<?= site_url('forgot_password/updatePassword') ?>" method="POST">
                    <!-- Token hidden field -->
                    ...
                    <div class="relative flex items-center">
                        ...
                        <button type="button" onclick="togglePassword()"
                            class="absolute inset-y-0 right-0 flex items-center justify-center px-2 text-gray-600 dark:text-gray-400">
                            <svg id="eyeIcon" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.522 5 12 5c4.478 0 8.268 2.943 9.542 7-.274.76-.624 1.466-1.042 2.105M15 12a3 3 0 11-6 0 3 3 0 016 0zm6.042 2.105A10.042 10.042 0 0112 19c-4.478 0-8.268-2.943-9.542-7 .274-.76.624-1.466 1.042-2.105"></path>
                            </svg>
                        </button>
                    </div>
